...
Software engineer in Denver [@Tailscale](https://github.com/tailscale). Mostly Go and all security products. Previously at HashiCorp: worked on Vault and led the launch of HCP Boundary.
